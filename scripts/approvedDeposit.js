...
const ABI = require("../artifacts/contracts/story.sol/story.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("story");
  const nft = await NFT.attach("0x9fAEc8F0784d730610b8d54754d7B9Db20f7ac1B");
